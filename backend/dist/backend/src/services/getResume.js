...
exports.changeResumeStatus = exports.getResumeById = void 0;
/**
 ...
 */
const getResumeById = (dbPool, req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      // Query ausführen
      const [results] = yield connection.query(query, [id]);
      ...
      const resume = {
        ...
        contactCompany: row.contactCompany_Id
          ? {
              ...
              company: row.contactCompany_CompanyId,
        ...
        contactRecrutingCompany: row.contactParentCompany_Id
          ? {
              ...
              company: row.contactParentCompany_CompanyId,
...
const changeResumeStatus = (db, req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const [rows] = yield db.query('SELECT ref, stateid FROM resumes WHERE resumeId = ?', [
        resumeId,
      ]);
      ...
      yield db.query('UPDATE resumes SET stateid = ? WHERE resumeId = ?', [stateId, resumeId]);
      yield db.query('INSERT INTO history (resumeid, stateid, date) VALUES (?, ?, ?)', [
        resumeId,
        stateId,
        date,
      ]);
...
exports.changeResumeStatus = changeResumeStatus;
