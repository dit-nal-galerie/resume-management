...
export default function ResumeEditContainer({ initial }: { initial: Resume | null }) {
  ...
  const [modalSectionCompany, setModalSectionCompany] = React.useState<ModalSectionCompany | null>(
    null
  );
  const [modalSectionContact, setModalSectionContact] = React.useState<ModalSectionContact | null>(
    null
  );
  ...
  const handleSelectContact = (c: Contact) => {
    ...
    const key =
      modalSectionContact === 'contactCompany' ? 'contactCompany' : 'contactRecrutingCompany';
  ...
  const initialCompanyData: Company = modalSectionCompany
